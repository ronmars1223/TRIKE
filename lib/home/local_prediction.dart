...
class LocationSuggestionService {
  ...
  static List<LocalPrediction> filterLocalSuggestions(String query,
      List<LocalPrediction> recentPlaces, List<LocalPrediction> popularPlaces) {
    final lowercaseQuery = query.toLowerCase();
    List<LocalPrediction> results = [];

    // First check recents (higher priority)
    results.addAll(recentPlaces.where((place) =>
    ...
    results.addAll(popularPlaces.where((place) =>
        place.mainText.toLowerCase().contains(lowercaseQuery) ||
        place.secondaryText.toLowerCase().contains(lowercaseQuery)));
